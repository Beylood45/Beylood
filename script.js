...
(function () {
  ...
  const dict = {
    so: {
      ...
      navArticles: 'Maqaallo', navNews: 'Wararka', navWeather: 'Cimilada', navCalc: 'Xisaabiyaha Beeraha', navFaq: "Su'aalaha (FAQ)", navAbout: 'Nagu saabsan', navContact: 'Nala soo xidhiidh',
    ...
    en: {
      ...
      navArticles: 'Articles', navNews: 'News', navWeather: 'Weather', navCalc: 'Farm Calculators', navFaq: 'FAQ', navAbout: 'About', navContact: 'Contact',
      askBtn: 'ASK BEYLOOD',
    ...
    ar: {
      ...
      navArticles: 'المقالات', navNews: 'الأخبار', navWeather: 'الطقس', navCalc: 'حاسبات المزرعة', navFaq: 'الأسئلة الشائعة', navAbout: 'من نحن', navContact: 'اتصل بنا',
      askBtn: 'اسأل بيلود',
      heroEy: 'منصة زراعية',
    ...
    sw: {
      ...
      navArticles: 'Makala', navNews: 'Habari', navWeather: 'Hali ya Hewa', navCalc: 'Vikokotoo vya Shamba', navFaq: 'Maswali (FAQ)', navAbout: 'Kuhusu', navContact: 'Wasiliana',
